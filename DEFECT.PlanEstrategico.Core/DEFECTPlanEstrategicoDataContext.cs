...
{
    public partial class DEFECTPlanEstrategicoDataContext
    {
        const string CONNECTIONSTRING_KEY = "AppDb";
        public DEFECTPlanEstrategicoDataContext WithConnectionStringFromConfiguration(string key)
        {
        ...
        public DEFECTPlanEstrategicoDataContext WithConnectionStringFromConfiguration()
        {
